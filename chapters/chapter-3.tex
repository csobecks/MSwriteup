...
\end{equation}
\%begin{equation}
 %   \avg{N}=\sum_i \avg{p_i}=\sum_i %\frac{e^{-\beta(E_i-\mu)}}{Z_{GC}}
%\end{equation}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{figures/pdf/quadE_nondeg_N10_Δ0=6.333.png}
...
We can see that the error follows the theory once $\beta$ is sufficiently large. To further inspect this, I will rewrite Eq.\@ (\ref{filldegen}) in the following way. 
\begin{align}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.75]{figures/pdf/quadE_filldegen_g0-2_N10_Δ0-7.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.75]{figures/pdf/quadE_filldegen_g0-2_N10_Δ0-7_1.png}
    \caption{Error in $\beta^*$ measurement for a quadratic energy spectrum with a filled
degenerate Fermi level. The figure is adjusted to plot Eq.\@ (\ref{3.2}). Once $\Delta_0\beta$ is large enough, the $\ln(g_0g_1)$ limit is reached. For the case shown above, $g_0=2$ and $g_1=1$ so the asymptotic limit is $\ln(2)$ as shown in orange.}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.75]{figures/pdf/linE_partfilldegen_N9_g0-2_l-1_Δ0-1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.75]{figures/pdf/linE_partfilldegen_N9_g0-2_l-1_Δ0-1_1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.75]{figures/pdf/quadE_partfilldegen_g0-2_l-1_N9_Δ0-7.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.75]{figures/pdf/quadE_partfilldegen_g0-2_l-1_N9_Δ0-7_1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{figures/pdf/linE_almostdegen_nondegen_g0-2_l-1_N10_Δ0-1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.75]{figures/pdf/quadE_almostdegen_nondegen_g0-2_l-1_N10_Δ0-6.333.png}
