...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Thermometry of Non-Interacting Ultracold Fermi Gases}	       % title of thesis/dissertation
...
\newcommand{\hatem}[1]{ \textcolor[rgb]{0,0,1}{#1}}
...
\begin{document}
    ...
    \bibliographystyle{ieeetr} % bibliography style - recommend using apalike-doi as it hyperlinks DOIs
