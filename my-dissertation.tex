...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Low Temperature Thermometry}	       % title of thesis/dissertation
...
\begin{document}
    ...
    \bibliographystyle{abbrv} % bibliography style - recommend using apalike-doi as it hyperlinks DOIs
